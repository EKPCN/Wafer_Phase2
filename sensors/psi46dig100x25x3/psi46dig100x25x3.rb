module PSI46DIG100x25
  ...
  def PSI46DIG100x25.create(layout,sensor)
    ...
    Pixel.bumpPad($layerPassOpen,InnerPixel['bPDiaPassivation']-2e3,InnerPixel['bPX0'],InnerPixel['bPY0'])
    ...
    Pixel.routingImplant($layerNp,LargePixel['implantSizeX'],LargePixel['implantSizeY'], LargePixel['routingdist'], LargePixel['routingwidth'], LargePixel1['bPDia'], LargePixelBPPar, false)
    Pixel.routingImplant($layerAlu,LargePixel['implantSizeX']+2.0*LargePixel['metalOH'],LargePixel['implantSizeY']+2.0*LargePixel['metalOH'], LargePixel['routingdist']-LargePixel['metalOH'], LargePixel['routingwidth'], LargePixel1['bPDia'], LargePixelBPPar, true)
    Pixel.bumpPad($layerPassOpen,LargePixel1['bPDiaPassivation'],LargePixel1['bPX0'],LargePixel1['bPY0'])
    Pixel.bumpPad($layerAlu,LargePixel1['bPDia'],LargePixel1['bPX0'],LargePixel1['bPY0'])
    Pixel.bumpPad($layerPassOpen,LargePixel2['bPDiaPassivation'],LargePixel2['bPX0'],LargePixel2['bPY0'])
    Pixel.bumpPad($layerAlu,LargePixel2['bPDia'],LargePixel2['bPX0'],LargePixel2['bPY0'])
    Pixel.bumpPad($layerPassOpen,LargePixel3['bPDiaPassivation'],LargePixel3['bPX0'],LargePixel3['bPY0'])
    Pixel.bumpPad($layerAlu,LargePixel3['bPDia'],LargePixel3['bPX0'],LargePixel3['bPY0'])
    # create via grid
    i = 0
    sign = 1
    ...
    Pixel.ptImplant($layerNp,LeftPixel['implantSizeX'],InnerPixel['implantSizeY'],InnerPixel['PTX0'],InnerPixel['PTY0'],InnerPixel['PTholeDia'],InnerPixel['PTimplantDia'],0,-InnerPixel['shiftX'])
    Pixel.ptImplant($layerAlu,LeftPixel['implantSizeX']+2.0*InnerPixel['metalOH'],InnerPixel['implantSizeY']+2.0*InnerPixel['metalOH'],InnerPixel['PTX0'],InnerPixel['PTY0'],InnerPixel['PTholeDia']-2.0*InnerPixel['innerPTmetalOH'],-InnerPixel['shiftX'])
    Pixel.ptVia($layerAluVia,InnerPixel['viaX0'],InnerPixel['viaY0'],InnerPixel['viaDia'])
    Pixel.ptVia($layerAluVia,InnerPixel['viaX0'],-InnerPixel['viaY0'],InnerPixel['viaDia'])
    Pixel.pStop($layerPp, LeftPixel['implantSizeX']+2*InnerPixel['PSdistX'], InnerPixel['implantSizeY']+2*InnerPixel['PSdistY'], InnerPixel['PSwidth'], InnerPixel['PSrOut'] , InnerPixel['PSrIn'], InnerPixel['PSopenX0'], InnerPixel['PSopenY0'], InnerPixel['PSopenWidth'],true)
    ...
    Pixel.bumpPad($layerPassOpen,InnerPixel['bPDiaPassivation']-2e3,InnerPixel['bPX0'],InnerPixel['bPY0']-UpperRow['Yplus']/2)
    Pixel.bumpPad($layerAlu,InnerPixel['bPDia'],InnerPixel['bPX0'],InnerPixel['bPY0']-UpperRow['Yplus']/2)
    ...
    Pixel.routingImplant($layerNp,LargePixel['implantSizeX'],LargePixel['implantSizeY']+UpperRow['Yplus'], LargePixel['routingdist'], LargePixel['routingwidth'], LargePixel1['bPDia'], LargePixelBPPar, false)
    Pixel.routingImplant($layerAlu,LargePixel['implantSizeX']+2.0*LargePixel['metalOH'],LargePixel['implantSizeY']+UpperRow['Yplus']+2.0*LargePixel['metalOH'], LargePixel['routingdist']-LargePixel['metalOH'], LargePixel['routingwidth'], LargePixel1['bPDia'], LargePixelBPPar, true)
    Pixel.bumpPad($layerPassOpen,LargePixel1['bPDiaPassivation'],LargePixel1['bPX0'],LargePixel1['bPY0']-UpperRow['Yplus']/2)
    Pixel.bumpPad($layerAlu,LargePixel1['bPDia'],LargePixel1['bPX0'],LargePixel1['bPY0']-UpperRow['Yplus']/2)
    Pixel.bumpPad($layerPassOpen,LargePixel2['bPDiaPassivation'],LargePixel2['bPX0'],LargePixel2['bPY0']-UpperRow['Yplus']/2)
    Pixel.bumpPad($layerAlu,LargePixel2['bPDia'],LargePixel2['bPX0'],LargePixel2['bPY0']-UpperRow['Yplus']/2)
    Pixel.bumpPad($layerPassOpen,LargePixel3['bPDiaPassivation'],LargePixel3['bPX0'],LargePixel3['bPY0']-UpperRow['Yplus']/2)
    Pixel.bumpPad($layerAlu,LargePixel3['bPDia'],LargePixel3['bPX0'],LargePixel3['bPY0']-UpperRow['Yplus']/2)
    # create via grid
    i = 0
    sign = 1
    # distance between vias
...
#     pixels are created from left to right
    ...
    Pixel.grid(largePixelCell,LargePixel['nX'], LargePixel['nY'], LargePixel['dX'], LargePixel['dY'], -PixelGrid['sizeX']/2+37.5e3+LargePixel['cellSizeX']/2, -PixelGrid['sizeY']/2+LargePixel['cellSizeY']/2)
    
    Pixel.grid(innerPixelCell2,InnerPixel['nX1'], InnerPixel['nY'], InnerPixel['dX'], InnerPixel['dY'], -PixelGrid['sizeX']/2+37.5e3+LargePixel['cellSizeX']+InnerPixel['cellSizeX']/2, -PixelGrid['sizeY']/2+LargePixel['cellSizeY']/2)
    
    Pixel.grid(innerPixelCell1,InnerPixel['nX1'], InnerPixel['nY'], InnerPixel['dX'], InnerPixel['dY'], -PixelGrid['sizeX']/2+37.5e3+LargePixel['cellSizeX']+3*InnerPixel['cellSizeX']/2, -PixelGrid['sizeY']/2+LargePixel['cellSizeY']/2)
    
    Pixel.grid(innerPixelCell2,InnerPixel['nX2'], InnerPixel['nY'], InnerPixel['dX'], InnerPixel['dY'], -PixelGrid['sizeX']/2+37.5e3+LargePixel['cellSizeX']+5*InnerPixel['cellSizeX']/2, -PixelGrid['sizeY']/2+LargePixel['cellSizeY']/2)
    
    Pixel.grid(rightPixelCell,RightPixel['nX'], InnerPixel['nY'], InnerPixel['dX'], InnerPixel['dY'], -PixelGrid['sizeX']/2+37.5e3+RightPixel['cellSizeX']/2+(InnerPixel['nX1']-1)*InnerPixel['dX']+LargePixel['cellSizeX']+InnerPixel['cellSizeX'], -PixelGrid['sizeY']/2+LargePixel['cellSizeY']/2)
    
    
#    upper pixel row
    
#     puts (-PixelGrid['sizeY']/2+InnerPixel['nY']*InnerPixel['cellSizeY']+InnerPixel['cellSizeY']/2)
    ...
    Pixel.grid(ulargePixelCell,LargePixel['nX'], UpperRow['nY'], LargePixel['dX'], LargePixel['dY'], -PixelGrid['sizeX']/2+37.5e3+LargePixel['cellSizeX']/2, -PixelGrid['sizeY']/2+InnerPixel['nY']*InnerPixel['cellSizeY']+(UpperRow['Yplus']+InnerPixel['cellSizeY'])/2)
    
    Pixel.grid(uinnerPixelCell2,InnerPixel['nX1'], UpperRow['nY'], InnerPixel['dX'], InnerPixel['dY'], -PixelGrid['sizeX']/2+37.5e3+LargePixel['cellSizeX']+InnerPixel['cellSizeX']/2, -PixelGrid['sizeY']/2+InnerPixel['nY']*InnerPixel['cellSizeY']+(UpperRow['Yplus']+InnerPixel['cellSizeY'])/2)
    
    Pixel.grid(uinnerPixelCell1,InnerPixel['nX1'], UpperRow['nY'], InnerPixel['dX'], InnerPixel['dY'], -PixelGrid['sizeX']/2+37.5e3+LargePixel['cellSizeX']+3*InnerPixel['cellSizeX']/2, -PixelGrid['sizeY']/2+InnerPixel['nY']*InnerPixel['cellSizeY']+(UpperRow['Yplus']+InnerPixel['cellSizeY'])/2)
    
    Pixel.grid(uinnerPixelCell2,InnerPixel['nX2'], UpperRow['nY'], InnerPixel['dX'], InnerPixel['dY'], -PixelGrid['sizeX']/2+37.5e3+LargePixel['cellSizeX']+5*InnerPixel['cellSizeX']/2, -PixelGrid['sizeY']/2+InnerPixel['nY']*InnerPixel['cellSizeY']+(UpperRow['Yplus']+InnerPixel['cellSizeY'])/2)
    
    Pixel.grid(urightPixelCell,RightPixel['nX'], UpperRow['nY'], InnerPixel['dX'], InnerPixel['dY'], -PixelGrid['sizeX']/2+37.5e3+RightPixel['cellSizeX']/2+(InnerPixel['nX1']-1)*InnerPixel['dX']+LargePixel['cellSizeX']+InnerPixel['cellSizeX'], -PixelGrid['sizeY']/2+InnerPixel['nY']*InnerPixel['cellSizeY']+(UpperRow['Yplus']+InnerPixel['cellSizeY'])/2)
