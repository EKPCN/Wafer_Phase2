module Roc4Sens100x25bwide
  ...
  def Roc4Sens100x25bwide.create()
  
    load "Wafer_Phase2/sensors/pspray/Roc4Sens100x25bwide/roc4sens100x25bwide_para.rb"
        
    $sensor = $layout.create_cell("Roc4Sens100x25brickedwide")
