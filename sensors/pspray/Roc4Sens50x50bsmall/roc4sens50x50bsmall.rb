module Roc4Sens50x50bsmall
  ...
  def Roc4Sens50x50bsmall.create()
  
    load "Wafer_Phase2/sensors/pspray/Roc4Sens50x50bsmall/roc4sens50x50bsmall_para.rb"
    ...
    Pixel.createVia($layerAluVia, Via['sizeX'],Via['sizeY'],-4e3,-6e3)
    ...
    Pixel.createVia($layerAluVia, Via['sizeX'],Via['sizeY'],0,-10e3)
