module RD53100x25symcPTw
  
  include RBA

  def RD53100x25symcPTw.create(layout,sensor)
    ...
    name = sensor + "."
	  ...
	  Pixel.cptMetal($layerAlu,ImplantRouting['sizeX'],InnerPixel['implantSizeY']+2.0*InnerPixel['metalOH'],InnerPixel['PTX0']-(InnerPixel['implantSizeX']+2.0*InnerPixel['metalOH']-ImplantRouting['sizeX'])/2.0,InnerPixel['PTY0'],InnerPixel['PTholeDia']-2.0*InnerPixel['innerPTmetalOH'],-InnerPixel['shiftX']+(InnerPixel['implantSizeX']+2.0*InnerPixel['metalOH']-ImplantRouting['sizeX'])/2.0,0,WiggleBiasLine['cutfrommetal'])
