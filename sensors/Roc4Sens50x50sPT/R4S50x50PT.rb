module R4S50x50PT
  ...
  def R4S50x50PT.create()
    ...
    Pixel.createPTImplant($layerNp,InnerPixel['implantSizeX'],InnerPixel['implantSizeY'],InnerPixel['PTX0'],InnerPixel['PTY0'],InnerPixel['PTholeDia'],InnerPixel['PTimplantDia'])
    Pixel.createPTMetal($layerAlu,InnerPixel['implantSizeX']+2.0*InnerPixel['metalOH'],InnerPixel['implantSizeY']+2.0*InnerPixel['metalOH'],InnerPixel['PTX0'],InnerPixel['PTY0'],InnerPixel['PTholeDia']-2.0*InnerPixel['metalOH'],InnerPixel['bLHoleWidth'])
    ...
    Pixel.createPTMetal($layerAlu,OuterPixel['implantSizeX']+2.0*OuterPixel['metalOH'],OuterPixel['implantSizeY']+2.0*OuterPixel['metalOH'],OuterPixel['PTX0'],OuterPixel['PTY0'],OuterPixel['PTholeDia']-2.0*OuterPixel['metalOH'],OuterPixel['bLHoleWidth'])
    ...
    Pixel.createPTMetal($layerAlu,UpperPixel['implantSizeX']+2.0*UpperPixel['metalOH'],UpperPixel['implantSizeY']+2.0*UpperPixel['metalOH'],UpperPixel['PTX0'],UpperPixel['PTY0'],UpperPixel['PTholeDia']-2.0*UpperPixel['metalOH'],UpperPixel['bLHoleWidth'])
    Pixel.createPTVia($layerAluVia,UpperPixel['PTX0'],UpperPixel['PTY0'],UpperPixel['PTviaDia'])
    Pixel.createPTBiasLine($layerAlu,UpperPixel['cellSizeX'],UpperPixel['cellSizeY'],UpperPixel['PTX0'],UpperPixel['PTY0'],UpperPixel['bDotDia'],UpperPixel['bLWidth'])
    ...
    Pixel.createPTMetal($layerAlu,CornerPixel['implantSizeX']+2.0*CornerPixel['metalOH'],CornerPixel['implantSizeY']+2.0*CornerPixel['metalOH'],CornerPixel['PTX0'],CornerPixel['PTY0'],CornerPixel['PTholeDia']-2.0*CornerPixel['metalOH'],CornerPixel['bLHoleWidth'])
    Pixel.createPTVia($layerAluVia,CornerPixel['PTX0'],CornerPixel['PTY0'],CornerPixel['PTviaDia'])
    Pixel.createPTBiasLine($layerAlu,CornerPixel['cellSizeX'],CornerPixel['cellSizeY'],CornerPixel['PTX0'],CornerPixel['PTY0'],CornerPixel['bDotDia'],CornerPixel['bLWidth'])
